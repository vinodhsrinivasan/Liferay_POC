...
public interface RequestFundsMapper {
	...
	static final String SQL="select  SACWIS.GET_PERSON_NAME_FORMAT(p.person_id, 'LSFM') , p.birth_date, p.person_id, cp.CURRENT_STATUS_CODE,cpr.RELATIONSHIP_CODE,"+
            " lce.CUSTODY_START_DATE, lcal.AGENCY_ID ,  ps.PLACEMENT_SETTING_ID, e.IVE_ELIGIBLE_INDICATOR "+
	...
	@Select(SAMPLE)
	public List<CaseDetails> searchBasedOnSacwisId(@Param("userId") String userId);
